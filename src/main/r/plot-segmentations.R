...
option_list <- list(
    ...
    make_option("--colors", type="character", default="orange,blue,purple,cyan,green", help="The colors to use as a comma-separated list, one color for each segmentations  (default: orange,blue,purple,cyan,green)"),
